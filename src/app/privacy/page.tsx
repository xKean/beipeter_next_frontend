...
export default function Privacy() {
  return (
    <SimpleLayout
      title="Datenschutzerklärung"
      intro="Hier finden Sie Informationen über die Erhebung, Verarbeitung und Nutzung personenbezogener Daten auf unserer Website."
    >
      <div className="prose mx-auto dark:prose-invert">
        ...
        <p>
          ...
          <br />
          <br />
          Telefon: 06648 9119 719
          <br />
          E-Mail: service@oliPro.net
          <br />
          <br />
          Gesch&auml;ftsf&uuml;hrer: Oliver Becker
          <br />
          Handelsregister: Fulda, HRB7336
          <br />
          Umsatzsteuer-Id.-Nr. (&sect;27a UStG): DE 26 663 0674
          <br />
          inhaltlich Verantwortlicher (&sect;10 MDStV): Oliver Becker
        </p>
